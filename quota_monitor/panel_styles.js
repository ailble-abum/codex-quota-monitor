  ...
  function panelCSS() {
    return `
      ...
      #codex-context-token-inspector-mascot [data-gauge] {
        position:absolute; top:50%; transform:translateY(-50%); display:flex; opacity:1;
        flex-direction:column; gap:4px; width:7px;
        transition:opacity .18s ease,transform .18s ease;
      }
      #codex-context-token-inspector-mascot[data-edge="left"] [data-gauge] { transform-origin:left center; }
      #codex-context-token-inspector-mascot[data-edge="right"] [data-gauge] { transform-origin:right center; }
      #codex-context-token-inspector-mascot[data-panel-revealed="true"] [data-gauge] {
        opacity:0; transform:translateY(-50%) scaleX(0); pointer-events:none;
      }
      ...
      #codex-context-token-inspector-mascot[data-edge="left"] [data-gauge] { right:-7px; }
      #codex-context-token-inspector-mascot[data-edge="right"] [data-gauge] { left:-7px; }
      ...
      #codex-context-token-inspector-mascot[data-art="true"][data-edge="right"] [data-gauge] { left:calc(var(--cti-gauge-left,-7px) - 4px); }
      #codex-context-token-inspector-mascot[data-art="true"][data-edge="left"] [data-gauge] { right:calc(var(--cti-gauge-right,-7px) - 4px); }
