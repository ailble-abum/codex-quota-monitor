...
def build(directory):
    ...
    script = cut(script, '  function dockSafeTop(', '  function clearDockHide(')
    script = cut(script, '  function dockVerticalY(', '  __COMPANION_FEEDBACK__')
    script = cut(script, '  function dockCandidate(', '  function applyDockPosition(')
    script = cut(script, '  function presetWidth(', '  function syncExpandedAnchor(')
    script = cut(script, '  function resizeGeometry(', '  function installHudDrag(')
