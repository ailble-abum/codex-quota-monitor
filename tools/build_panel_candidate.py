...
def build(directory):
    ...
    script = cut(script, '  function mascotSvg(', '  function quotaTone(')
    script = cut(script, '  function createRetainedMascot(', '  function applyCompanionExpression(')
    script = cut(script, '  function applyCompanionExpression(', '  function companionReact(')
    script = cut(script, '  function companionReact(', '  function applyCompanionFeedback(')
    script = cut(script, '  function applyCompanionFeedback(', '  function applyMascotSkin(')
    script = cut(script, '  function applyMascotSkin(', '  function undockHud(')
    ...
    script = (script[:script.index(tail)] + (assets / 'panel_format.js').read_text()
              ...
              + (assets / 'panel_companion_runtime.js').read_text()
