...
root.querySelectorAll=()=>new Array(4); assert.equal(context.hudBase(root),370);
...
assert.equal(context.presetWidth(root,'mini'),303); assert.equal(context.presetWidth(root,'large'),444);
