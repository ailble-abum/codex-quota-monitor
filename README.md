...
独立替换工作区，已实现日志增量读取、会话状态归约、任务身份核对、旧面板数值投影与离线预览，尚无可安装版本。
...
实现及证据见 [读取器契约](docs/reader-contract.md)、[会话归约器契约](docs/session-contract.md)、[数值兼容桥](docs/compat-contract.md) 和 [身份核对](docs/identity-contract.md)。运行合成测试：
