...
<p align="center">
  <a href="https://github.com/ailble-abum/codex-quota-monitor/releases/tag/v2.0.11"><strong>下载 macOS 正式版</strong></a>
  &nbsp;·&nbsp;
  <a href="#快速开始">快速开始</a>
  &nbsp;·&nbsp;
  <a href="docs/RELEASE-v2.0.11.md">发行说明</a>
</p>
...
1. 从 [v2.0.11 发布页](https://github.com/ailble-abum/codex-quota-monitor/releases/tag/v2.0.11)下载 macOS ZIP 和 `SHA256SUMS`。在下载目录运行 `shasum -a 256 -c SHA256SUMS`，通过后解压到新目录。
...
[发行说明](docs/RELEASE-v2.0.11.md) · [验证记录](docs/BETA-VALIDATION.md) · [资源来源](docs/asset-provenance.md)
